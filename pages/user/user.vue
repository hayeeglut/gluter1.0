		...
		onLoad: function(option) {
			...
			uni.login({
				...
				success: function(event) {
					...
					uni.request({
						url: 'https://neeeeeeebs.fit:8088/wx_get_true_openid/get',
						header: {
						...
						success: (res) => {
							...
							//去userinfo表查找是否存在用户
							uni.request({
								url: "https://neeeeeeebs.fit:8088/userInfo/wechat/find_user",
								header: {
									'content-type': 'application/x-www-form-urlencoded'
								},
								method: 'POST',
								...
								success: (res) => {
									...
									if (res.data.a == true) {
										...
										that.getKeBiao();
										uni.request({
											url: "https://neeeeeeebs.fit:8088/userInfo/wechat/getUserName",
											header: {
												'content-type': 'application/x-www-form-urlencoded'
											},
											method: 'POST',
		...
		methods: {
			...
			xiuGaiXueHaoMiMa(res) {
				...
				uni.request({
					...
					url: 'https://neeeeeeebs.fit:8088/userInfo/wechat/deleteUser',
					method: 'POST',
					header: {
						'content-type': 'application/x-www-form-urlencoded'
					},
			...
			fanKui(result) {
				...
				if (that.fanKuiNeiRong != null) {
					...
					uni.request({
						...
						url: 'https://neeeeeeebs.fit:8088/userInfo/wechat/changeUserName',
						method: 'POST',
						header: {
							'content-type': 'application/x-www-form-urlencoded'
						},
			...
			gengXinKeBiao(res) {
				...
				uni.request({
					...
					url: 'https://neeeeeeebs.fit:8088/keBiao/wechat/reNewKeBiao',
					method: 'POST',
					header: {
						'content-type': 'application/x-www-form-urlencoded'
					},
			...
			getTongZhi() {
				uni.request({
					url: 'https://neeeeeeebs.fit:8088/tongZhi/getToolTop',
					header: {
						'content-type': 'application/x-www-form-urlencoded'
					},
					method: "POST",
			...
			createUser(res) {
				...
				var that = this;
				uni.request({
					url: "https://neeeeeeebs.fit:8088/userInfo/wechat/createUser",
					method: "POST",
					header: {
						'content-type': 'application/x-www-form-urlencoded'
					},
			...
			getKeBiao(res) {
				var that = this;
				uni.request({
					url: "https://neeeeeeebs.fit:8088/keBiao/wechat/getKeBiao",
					header: {
						'content-type': 'application/x-www-form-urlencoded'
					},
					data: {
